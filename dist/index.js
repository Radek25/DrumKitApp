...
var Metronome = (function () {
    ...
    Metronome.prototype.useMetronome = function () {
        ...
        this.setMetronomeButton.addEventListener('click', function () {
            ...
            _this.resetMetronomeButton.innerHTML = '<i class="far fa-times-circle"></i>';
    ...
    Metronome.prototype.addBPMValue = function () {
        var _this = this;
        this.resetMetronomeButton.addEventListener('click', function () {
            ...
            if (_this.isInputOpen === true) {
                ...
                _this.resetMetronomeButton.innerHTML = '<i class="far fa-check-circle"></i>';
            }
            else {
                _this.setBPMValue();
